...
#-----------------------------------------------------------------------------
vendor_saved_apps := Bluetooth CMFileManager LatinIME Term
...
#-----------------------------------------------------------------------------
baidu_remove_apps := BaiduSocialShare BaiduUserFeedback iReader SearchBox YiYueDu ResManager BaiduMap BaiduAppSearch GameCenter BaiduInput TimeService BaiduLightApp
...
override_property += \
    ro.baidu.romer=Akun rufeng ljzyal wwbhl
    ro.product.device.alias=i9260,GT-I9260,superior,superiorchn
